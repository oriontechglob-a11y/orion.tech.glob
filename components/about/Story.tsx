  ...
  return (
    <AnimatedSection className="grid gap-10 py-20 md:grid-cols-[0.9fr_1.1fr] md:items-center sm:py-24">
      ...
      <motion.div variants={childReveal} className="space-y-5 text-lg leading-8 text-muted">
        <p>
          SH Global is a subsidiary of Shree Hari Hardware Mart and focuses on app development, web
          development, and custom digital products. We partner with businesses that want thoughtful
          strategy, polished design, and dependable engineering in one team.
        </p>
        <p>
