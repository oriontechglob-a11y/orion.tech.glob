...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Learn about SH Global, a subsidiary of Shree Hari Hardware Mart, building apps, websites, and custom software.",
  openGraph: {
    title: "About SH Global",
  ...
  return (
    <>
      <AnimatedSection className="pt-36 pb-16 text-center sm:pt-40">
        <p className="text-sm font-bold uppercase tracking-[0.24em] text-accent">About SH Global</p>
